...
export default function Page() {
  return (
    <main className="container relative mx-auto scroll-my-12 overflow-auto p-4 print:p-12 md:p-16" style={{ width: "21cm", height: "29.7cm", maxWidth: "100%", maxHeight: "100%", margin: "auto" }}>
      <div className="flex">
